...
public class CSVReader_Writer {
     ...
     * You should also close the BufferedReader in the finally block
     * @return List<String> of male first names
     */
    public static List<String> getMaleFirstNames() {
        ...
        try {
            ...
            System.out.println("File not found: firstname_males.txt. " + e.getMessage());
        } catch (IOException e) {
            System.out.println("Error reading file: firstname_males.txt. " + e.getMessage());
        } finally {
            if (reader != null) {
                try {
                    reader.close();
     ...
     * @return List<String> of female first names
     */
     ...
     * This method might throw IOException which due to the throws clause needs to
    ...
    public static void saveLastNames(List<String> lastNames) {
        try (BufferedWriter writer = Files.newBufferedWriter(Paths.get("lastnames.txt"))) {
            ...
            System.out.println("Error writing to file: lastnames.txt. " + e.getMessage());
        }
    }
